...
const socialLinks = [
    ...
    {
      href: 'https://www.instagram.com/farrasazhary/',
    ...
    >
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex-col">
                ...
                <p className="textzinc-400 mb-8 mt-3 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href, icon, alt}, key) =>(
                        ...
                        href={href}
                        target='_blank' 
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[bacgkround-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                        >
                            {icon}
                        </a>
                    ))}
            ...
            <form 
                    action="https://getform.io/f/apjjlgxa" 
                    method="POST"
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            <input 
                                ...
                                autoComplete="email"
                                required
                                placeholder="farrasaszhary@example.com" 
                                className="text-field reveal-up" 
                            />
                        </div>
                    </div>
